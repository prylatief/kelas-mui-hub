...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-mui-teal to-mui-blue text-white shadow-md relative overflow-hidden">
      {/* Wave Background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex items-center justify-between py-4">
          <Link to="/" className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-full bg-white text-mui-teal flex items-center justify-center font-bold">
              M
            </div>
            <span className="font-bold text-xl flex items-center">
              <Waves size={18} className="mr-1" />
              Kelas PKU MUI
            </span>
          </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 animate-fade-in">
            <div className="flex flex-col space-y-4">
              <Link 
                to="/repository" 
                className="hover:bg-white/10 p-2 rounded transition-colors flex items-center gap-2"
